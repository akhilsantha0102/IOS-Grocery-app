...
//                    LazyVGrid(columns: columns, spacing: 30) {
//                        ForEach(0..<items.count, id: \.self) { item in
//                            let imageName = items[item][0] as! String
//                            let title = items[item][1] as! String
//                            let price = items[item][2] as! Double
//                            let color = items[item][3] as! Color
//
//                            ShopItem(imageName: imageName, title: title, price: price, color: color, selfIndex: item, cartItems: $cartItems)
//
//
//
//                        }
